...
| [api.md](api.md) | 全部 79 路径 / 97 方法注册（当日 OpenAPI 活体导出）+ 分权矩阵 | 对接前端/写客户端 |
| [data-model.md](data-model.md) | 24 张业务表、22 个迁移、数据流 | 改 schema 前必读 |
...
cargo test --workspace        # 144 passed / 0 failed（36 个套件）
