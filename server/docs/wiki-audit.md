...
| 本清单 | 对应 | 关系 |
|---|---|---|
| W1 | K1（已修）、E2E 实测脆点 | 同构三连（幂等墙+错误分类+自愈），K1 修法可平移但多一层文件自删 |
| W3 | K4/K8（已修） | 同类双静默，且 wiki 更彻底（连 tsv 都没有） |
| W4 | K1 可见性半部 | mark_failed + 自愈平移 |
| W6 | G1 | gap-analysis 并发去重缺口的具体化 |
| W12 | G 系列异步人审 | 提案应进 review_items 而非事件流 |
| W2/W5/W7/W8/W9~W14 | 新发现 | wiki 特有 |
