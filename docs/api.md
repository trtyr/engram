...
全栈共一个 HTTP API，**89 路径 / 114 方法注册**（GET 47 · POST 47 · PUT 7 · PATCH 3 · DELETE 10，2026-09-05
...
| mcp | POST /mcp（Streamable HTTP JSON-RPC）、GET /settings/mcp | 用户记忆域 MCP 工具面（9 工具，memory scope；管理信息 admin-only） |
